...
@Component({
  selector: 'app-digital-sb-group',
  templateUrl: './digital-sb-group.component.html',
  styleUrls: ['./digital-sb-group.component.css']
})
export class DigitalSbGroupComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.activatedRoute.params.subscribe(
      params => {
        ...
        this.fixedUrl = 'sb-group/'+params.url;
