...
@Component({
  selector: 'app-digital-sb-financial-services',
  templateUrl: './digital-sb-financial-services.component.html',
  styleUrls: ['./digital-sb-financial-services.component.css']
})
export class DigitalSbFinancialServicesComponent implements OnInit {
  public mapData: any;
  ...
  constructor(private router: Router, private activatedRoute: ActivatedRoute, private cardService: CardService, private mapsData: MapsDataService,) { }
  ...
  ngOnInit(): void {
    ...
    this.activatedRoute.params.subscribe(
      params => {
        ...
        this.fixedUrl = 'sb-financial-services/'+params.url;
