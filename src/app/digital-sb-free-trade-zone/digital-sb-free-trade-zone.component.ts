...
@Component({
  selector: 'app-digital-sb-free-trade-zone',
  templateUrl: './digital-sb-free-trade-zone.component.html',
  styleUrls: ['./digital-sb-free-trade-zone.component.css']
})
export class DigitalSbFreeTradeZoneComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.activatedRoute.params.subscribe(
      params => {
        ...
        this.fixedUrl = 'sb-free-trade-zone/'+params.url;
